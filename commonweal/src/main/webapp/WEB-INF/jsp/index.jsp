					...
					<div class="tab-content" id="menu">
						...
						<div class="tab-pane fade" id="info">
							...
							<ul class="text-center infoul"
								...
								<li><span>通知标题：</span> <span> <input type="text"
										value="">
								</span></li>
							...
							<div style="padding: 5px;">
								<table class="infotable" width="100%">
									...
									<tr>
										<th><span>1000</span></th>
										<th><span>寻人</span></th>
										<th><span>钥匙上面有个U盘在金水区丢的</span></th>
										<th><span>2017-12-18</span></th>
										<th><span>超级管理员</span></th>
										<th><span class="col-xs-6" style="width: 50%;"> <a
												class="manage" href="#">删除</a>
										</span></th>
									</tr>
						...
						<div class="tab-pane fade" id="message">
							<form style="padding-top: 5px">
								<p>
									<span class="form-group"> 发 送 人：<input type="text"
										placeholder="请输入发送人联系方式" class="input-sm" />
							...
							<div style="padding: 5px;">
								<table width="100%">
									...
									<tr>
										<th><span>1000</span></th>
										<th><span>孩子丢了</span></th>
										<th><span>1123123123</span></th>
										<th><span>已认领</span></th>
